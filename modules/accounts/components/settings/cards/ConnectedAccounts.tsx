...
import {InlineSVG, toAbsoluteUrl} from '../../../../../_oxygen/helpers'
  ...
  return (
    <div className='card mb-5 mb-xl-10'>
      <div
        ...
        data-bs-target='#xgn_account_connected_accounts'
        aria-expanded='true'
        aria-controls='xgn_account_connected_accounts'
      >
      ...
      <div id='xgn_account_connected_accounts' className='collapse show'>
