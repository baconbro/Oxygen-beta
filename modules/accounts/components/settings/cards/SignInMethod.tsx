...
const SignInMethod: React.FC = () => {
  ...
  const formik1 = useFormik<IUpdateEmail>({
    ...
    onSubmit: (values) => {
      setLoading1(true)
      setTimeout(() => {
        FirestoreService.updateUserEmail(values.newEmail)
        .then(() => {
  ...
  return (
    <div className='card mb-5 mb-xl-10'>
      <div
        ...
        data-bs-target='#xgn_account_signin_method'
      >
      ...
      <div id='xgn_account_signin_method' className='collapse show'>
        <div className='card-body border-top p-9'>
          <div className='d-flex flex-wrap align-items-center'>
            ...
            <div id='xgn_signin_email_button' className={'ms-auto ' + (showEmailForm && 'd-none')}>
              <button
                onClick={() => {
          ...
          <div className='d-flex flex-wrap align-items-center mb-10'>
            <div id='xgn_signin_password' className={' ' + (showPasswordForm && 'd-none')}>
              <div className='fs-6 fw-bolder mb-1'>Password</div>
              <div className='fw-bold text-gray-600'>************</div>
            </div>

            <div
              id='xgn_signin_password_edit'
              className={'flex-row-fluid ' + (!showPasswordForm && 'd-none')}
            >
              <form
                onSubmit={formik2.handleSubmit}
                id='xgn_signin_change_password'
                className='form'
                noValidate
              >
          ...
          <div className='notice d-flex bg-light-primary rounded border-primary border border-dashed p-6'>
            ...
            <div className='d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap'>
              ...
              <a
                ...
                data-bs-target='#xgn_modal_two_factor_authentication'
              >
                Enable
              </a>
            </div>
