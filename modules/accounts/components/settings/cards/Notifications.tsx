  ...
  return (
    <div className='card mb-5 mb-xl-10'>
      <div
        ...
        data-bs-target='#xgn_account_notifications'
        aria-expanded='true'
        aria-controls='xgn_account_notifications'
      >
      ...
      <div id='xgn_account_notifications' className='collapse show'>
        <form className='form'>
                    ...
                    <td className='w-125px'>
                      <div className='form-check form-check-solid'>
                        <input
                          ...
                          type='checkbox'
                          value=''
                          id='xgn_settings_notification_email'
                        ...
                        <label
                          ...
                          htmlFor='xgn_settings_notification_email'
                        >
                          Email
                        </label>
                      </div>
                    ...
                    <td className='w-125px'>
                      <div className='form-check form-check-solid'>
                        <input
                          ...
                          type='checkbox'
                          value=''
                          id='xgn_settings_notification_phone'
                        ...
                        <label
                          className='form-check-label ps-2'
                          htmlFor='xgn_settings_notification_phone'
                        >
                          Phone
                        </label>
                      </div>
