...
class StickyComponent {
  ...
  constructor(_element: HTMLElement, options: StickyOptions) {
    ...
    this.instanceName = this.element.getAttribute('data-xgn-sticky-name')
    this.attributeName = 'data-xgn-sticky-' + this.instanceName
    ...
    if (reverse === true) {
      ...
      if (st > offsetNum && this.lastScrollTop < st) {
        ...
        if (this.eventTriggerState === true) {
          EventHandlerUtil.trigger(this.element, 'xgn.sticky.on')
          EventHandlerUtil.trigger(this.element, 'xgn.sticky.change')
        ...
        if (this.eventTriggerState === false) {
          EventHandlerUtil.trigger(this.element, 'xgn.sticky.off')
          EventHandlerUtil.trigger(this.element, 'xgn.sticky.change')
  ...
  private getOption = (name: string) => {
    const dataStickyAttr = 'data-xgn-sticky-' + name
  ...
  public static bootstrap(attr: string = '[data-xgn-sticky="true"]') {
    StickyComponent.createInstances(attr)
  }

  public static reInitialization(attr: string = '[data-xgn-sticky="true"]') {
    StickyComponent.createInstances(attr)
  }
}
