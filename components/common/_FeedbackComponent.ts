...
class FeedbackComponent {
  ...
  ///////////////////////
  public show = () => {
    if (EventHandlerUtil.trigger(this.element, 'xgn.feedback.show') === false) {
      return
    }
    ...
    EventHandlerUtil.trigger(this.element, 'xgn.feedback.shown')

    return this
  }

  public hide = () => {
    if (EventHandlerUtil.trigger(this.element, 'xgn.feedback.hide') === false) {
      return
    }
    ...
    this.shown = false
    EventHandlerUtil.trigger(this.element, 'xgn.feedback.hidden')
    return this
  }
