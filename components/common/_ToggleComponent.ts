import {DataUtil, getUniqueIdWithPrefix, EventHandlerUtil} from '../../utils/index'
// Helpers
...
class ToggleComponent {
  ...
  constructor(_element: HTMLElement, options: ToggleOptions) {
    ...
    const elementTargetAttr = this.element.getAttribute('data-xgn-toggle-target')
    if (elementTargetAttr) {
      this.target = document.querySelector(elementTargetAttr)
    }
    const elementToggleAttr = this.element.getAttribute('data-xgn-toggle-state')
    this.state = elementToggleAttr || ''
    const elementModeAttr = this.element.getAttribute('data-xgn-toggle-mode')
    this.mode = elementModeAttr || ''
    this.attribute = 'data-xgn-' + this.element.getAttribute('data-xgn-toggle-name')
  ...
  private _toggle = () => {
    ...
    EventHandlerUtil.trigger(this.element, 'xgn.toggle.change')
    ...
    EventHandlerUtil.trigger(this.element, 'xgn.toggle.changed')
    return this
  }
  ...
  private _enable = () => {
    ...
    EventHandlerUtil.trigger(this.element, 'xgn.toggle.enable')
    ...
    EventHandlerUtil.trigger(this.element, 'xgn.toggle.enabled')
    return this
  }
  ...
  private _disable = () => {
    ...
    EventHandlerUtil.trigger(this.element, 'xgn.toggle.disable')
    ...
    EventHandlerUtil.trigger(this.element, 'xgn.toggle.disabled')
    return this
  }
  ...
  public static reinitialization = () => {
    ToggleComponent.createInstances('[data-xgn-toggle]')
  }
