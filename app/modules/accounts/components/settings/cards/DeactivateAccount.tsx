  ...
  return (
    <div className='card'>
      <div
        ...
        data-bs-target='#xgn_account_deactivate'
        aria-expanded='true'
        aria-controls='xgn_account_deactivate'
      >
      ...
      <div id='xgn_account_deactivate' className='collapse show'>
        <form onSubmit={formik.handleSubmit} id='xgn_account_deactivate_form' className='form'>
          ...
          <div className='card-footer d-flex justify-content-end py-6 px-9'>
            <button
              id='xgn_account_deactivate_account_submit'
              type='submit'
