...
const UpgradePlan: FC = () => {
  ...
  return (
    <div className='modal fade' id='xgn_modal_upgrade_plan' aria-hidden='true'>
      <div className='modal-dialog modal-xl'>
        <div className='modal-content rounded'>
          <div className='modal-header justify-content-end border-0 pb-0'>
            <div className='btn btn-sm btn-icon btn-active-color-primary' data-bs-dismiss='modal'>
              <InlineSVG path='/media/icons/duotune/arrows/arr061.svg' className='svg-icon-1' />
            </div>
          </div>
          ...
          <div className='modal-body pt-0 pb-15 px-5 px-xl-20'>
            ...
            <div className='d-flex flex-column'>
              <div className='nav-group nav-group-outline mx-auto' data-xgn-buttons='true'>
                <a
                  href='#'
                  className={
                    ...
                    {plans.map((plan, index) => {
                      return (
                        <div
                          ...
                          data-bs-toggle='tab'
                          data-bs-target={`#xgn_upgrade_plan_${index}`}
                          key={index}
                        >
                            ...
                            {!plan.custom && (
                              <>
                                ...
                                <span className='fs-7 opacity-50'>
                                  /<span data-xgn-element='period'>Mon</span>
                                </span>
                              </>
                            )}
                          </div>
