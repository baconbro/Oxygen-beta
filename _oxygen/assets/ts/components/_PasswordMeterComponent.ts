...
const defaultPasswordMeterQueires: IPasswordMeterQueries = {
  ...
  instanseQuery: '[data-xgn-password-meter]',
  inputQuery: 'input[type]',
  visibilityQuery: '[data-xgn-password-meter-control="visibility"]',
  highlightQuery: '[data-xgn-password-meter-control="highlight"]',
}
