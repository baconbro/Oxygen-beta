...
const defaultSearchQueires: ISearchQueries = {
  ...
  instanseQuery: '[data-xgn-search]',
  attrQuery: 'data-xgn-search-',
}
...
class SearchComponent {
  ...
  private _getElement = (name: string) => {
    return this.element.querySelector('[data-xgn-search-element="' + name + '"]')
  }
  ...
  private handlers(): void {
    ...
    if (this.menuObject) {
      ...
      if (this.toggleElement) {
        ...
        this.menuObject.on('xgn.menu.dropdown.show', function () {
          // @ts-ignore
        ...
        this.menuObject.on('xgn.menu.dropdown.hide', function () {
          // @ts-ignore
          if (isVisibleElement(context.toggleElement)) {
            // @ts-ignore
      ...
      this.menuObject.on('xgn.menu.dropdown.shown', function () {
        // @ts-ignore
  ...
  public search = () => {
    if (!this.processing) {
      ...
      EventHandlerUtil.trigger(this.element, 'xgn.search.process', this)
    }
  }
  ...
  // Clear
  public clear = () => {
    if (EventHandlerUtil.trigger(this.element, 'xgn.search.clear') === false) {
      return
    }
    ...
    EventHandlerUtil.trigger(this.element, 'xgn.search.cleared')
  }
