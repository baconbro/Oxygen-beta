...
class ScrollComponent {
  ...
  constructor(_element: HTMLElement, options: ScrollOptions) {
    ...
    this.update()
    // this.element.setAttribute('data-xgn-scrolltop', 'true')
    DataUtil.set(this.element, 'scroll', this)
  }

  private getOption = (name: string) => {
    if (this.element.hasAttribute('data-xgn-scroll-' + name) === true) {
      const attr = this.element.getAttribute('data-xgn-scroll-' + name) || ''
  ...
  public update = () => {
    ...
    if (
      ...
      !this.element.hasAttribute('data-xgn-scroll-activate')
    ) {
      this.setupHeight()
  ...
  public static destroyAll(attr: string = '[data-xgn-scroll="true"]') {}

  public static bootstrap(attr: string = '[data-xgn-scroll="true"]') {
  ...
  public static reinitialization(attr: string = '[data-xgn-scroll="true"]') {
    ScrollComponent.createInstances(attr)
  }

  public static updateAll() {
    const elements = document.body.querySelectorAll('[data-xgn-scroll="true"]')
    elements.forEach((element: Element) => {
