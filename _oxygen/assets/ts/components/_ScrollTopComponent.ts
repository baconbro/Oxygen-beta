...
class ScrollTopComponent {
  ...
  private _scroll = () => {
    ...
    if (pos > offset) {
      if (!document.body.hasAttribute('data-xgn-scrolltop')) {
        document.body.setAttribute('data-xgn-scrolltop', 'on')
      }
    } else {
      if (document.body.hasAttribute('data-xgn-scrolltop')) {
        document.body.removeAttribute('data-xgn-scrolltop')
      }
    }
  }
  ...
  private _getOption = (name: string) => {
    const attr = this.element.getAttribute(`data-xgn-scrolltop-${name}`)
    if (attr) {
  ...
  public static bootstrap = () => {
    ScrollTopComponent.createInstances('[data-xgn-scrolltop="true"]')
  }
